# -*- coding: utf-8 -*-
"""
Created on Sat Apr  3 22:16:55 2021
...
model = T5ForConditionalGeneration.from_pretrained('prakhar_t5_model6/') # Model 6 with training set splitted in 95:5 ratio for train/val and run for 3 epochs
#tokenizer = T5Tokenizer.from_pretrained('prakhar_t5_model6/')
...
df.to_csv('file_model6.csv', index=False) 